...
This doc outlines the various responsibilities of contributor roles in Dapr. The Dapr project is subdivided into sub-projects under (predominantly, but not exclusively) Core runtime, Components, CLI, Quick-starts, Docs and language-specific SDKs. Responsibilities for most roles are scoped to these sub-projects (repos).
